...
//   - message string
func (_e *Logger_Expecter) Debug(message interface{}) *Logger_Debug_Call {
	return &Logger_Debug_Call{Call: _e.mock.On("Debug", message)}
}

func (_c *Logger_Debug_Call) Run(run func(message string)) *Logger_Debug_Call {
...
//   - message string
func (_e *Logger_Expecter) Error(message interface{}) *Logger_Error_Call {
	return &Logger_Error_Call{Call: _e.mock.On("Error", message)}
}

func (_c *Logger_Error_Call) Run(run func(message string)) *Logger_Error_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
//   - message string
func (_e *Logger_Expecter) Info(message interface{}) *Logger_Info_Call {
	return &Logger_Info_Call{Call: _e.mock.On("Info", message)}
}

func (_c *Logger_Info_Call) Run(run func(message string)) *Logger_Info_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
